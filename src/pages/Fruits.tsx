...
const Fruits = () => {
      ...
      if (type === 'difficulty') {
        ...
        if (isValidSeason(value)) {
          ...
          if (currentFilters.includes(seasonValue)) {
            // Create a new array with the season filtered out
            // Cast the result back to Season[] to maintain type safety
            ...
            // Add the season ensuring it's properly typed
  ...
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Fruits Guide | PickPerfect.org</title>
        <meta name="description" content="Learn how to select the sweetest, ripest fruits every time with our comprehensive selection guide." />
      </Helmet>
